...
<body class="bg-gray-100">
    <div class="min-h-screen flex" x-data="{ sidebarOpen: true }">
        <!-- Sidebar -->
        <aside :class="sidebarOpen ? 'w-64' : 'w-20'" class="bg-blue-900 text-white transition-all duration-300 fixed h-full z-30">
            <div class="p-4 flex items-center justify-between border-b border-blue-800">
                ...
                <button @click="sidebarOpen = !sidebarOpen" class="p-2 hover:bg-blue-800 rounded">
            ...
            <header class="bg-white shadow-sm border-b sticky top-0 z-20">
                <div class="px-6 py-4 flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-sm text-gray-500">@yield('breadcrumb')</p>
                    </div>
